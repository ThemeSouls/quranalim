  ...
  categories: [
    {
      ...
      roles: [
        ...
        { num: "2", role: "📝 رجسٹرڈ صارف (Registered User)", desc: "مفت اکاؤنٹ بنا کر آیات کو بک مارک کریں، ذاتی نوٹس لکھیں، اپنی تلاوت کی پیش رہفت کو ٹریک کریں، اور اپنی پسندیدہ ترتیبات محفوظ کریں۔" }
      ]
    },
    {
