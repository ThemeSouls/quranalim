export const resources = {
  quranBooks: {
    title: "تفاسير وشروح وتراجم القرآن الكريم",
    subtitle: "مستودع شامل للأدبيات القرآنية التاريخية والحديثة، والتفاسير، والتراجم العالمية عبر القرون.",
    commentaries: [
      {
        number: 1,
        ...
        year: "68 AH / ہجری",
        category: "التفاسير العربية الكلاسيكية (من القرن الأول إلى السابع الهجري)"
      },
      {
        number: 2,
        title: "تفسیر مجاہد",
      ...
      },
      {
        ...
        language: "Arabic / عربی",
        year: "412 AH / ہجری",
        category: "التفاسير الإشارية والصوفية"
      },
      {
        number: 26,
      ...
      },
      {
        ...
        language: "Arabic / عربی",
        year: "1354 AH / ہجری",
        category: "التفاسير العربية الحديثة (القرن 19 و 20)"
      },
      {
        number: 32,
      ...
      },
      {
        ...
        language: "Urdu / اردو",
        year: "1190 AH / ہجری",
        category: "التفاسير الأردية وشروحها"
      },
      {
        number: 44,
      ...
      },
      {
        ...
        year: "1934 CE / عیسوی",
        category: "التفاسير الإنجليزية وشروحها"
      },
      {
        number: 54,
    ...
    translations: [
      {
        ...
        language: "Arabic / عربی",
        year: "310 AH / ہجری",
        category: "التراجم العربية (اللفظية والتفسيرية)"
      },
      {
        number: 2,
      ...
      },
      {
        ...
        year: "982 AH / ہجری",
        category: "التراجم باللغات العالمية الأخرى"
      },
      {
        number: 29,
  ...
  hadithBooks: {
    title: "المجاميع المعتمدة للحديث النبوي (الكتب الستة)",
    subtitle: "الكتب الستة الموثقة للغاية والتي تحتوي على أقوال وأفعال وتقريرات النبي محمد صلى الله عليه وسلم.",
    books: [
      {
        id: "bukhari",
        ...
        description: "يُعتبر أصح كتاب بعد القرآن الكريم. قضى الإمام البخاري أكثر من 16 عامًا في جمع وتدقيق أكثر من 7,000 حديث صحيح باستخدام أدق معايير التحقق التي تم وضعها في التاريخ.",
        keyFeatures: [
          "أعلى مستويات شروط مصداقية الرواة (شرط اللقاء الصارم)",
          "عناوين فقهية مفصلة تمثل استنباطات فقهية معقدة (فقه البخاري)",
          "يشتمل على أقسام في العقيدة، والأخلاق، والتاريخ، والطب",
          "مقبول بالإجماع باعتباره قمة أدبيات الحديث"
        ]
      },
      {
        id: "muslim",
        ...
        description: "مكملاً لصحيح البخاري، يشتهر صحيح مسلم بترتيبه الموضوعي البديع وحفظه الصارم لألفاظ الرواة (سلامة السند).",
        keyFeatures: [
          "تنظيم موضوعي رائع مع تجميع الأسانيد المتعددة معًا",
          "التركيز على الاختلافات الدقيقة في الألفاظ بين الرواة",
          "مقدمة علمية شاملة في علم الحديث",
          "مصدر لا غنى عنه للتفسير الفقهي والعقيدة"
        ]
      },
      {
        id: "tirmidhi",
        ...
        description: "مجموعة متميزة تشتهر بتصنيف درجات الحديث (صحيح، حسن، ضعيف) وبيان آراء مختلف المدارس الفقهية (مرافق الفقه).",
        keyFeatures: [
          "يصنف بوضوح درجة كل حديث فردي",
          "يذكر أي الفقهاء (الصحابة والتابعين) عمل بالرواية",
          "تعليمي للغاية لطلاب الشريعة الإسلامية",
          "يتضمن كتاب الشمائل المحمدية الشهير"
        ]
      },
      {
        id: "abi-dawud",
        ...
        description: "تجمع هذه المجموعة الأحاديث التي تركز بشكل خاص على الأحكام الشرعية. وهي المورد الأول للمحامين والقضاة والفقهاء الباحثين عن الأدلة الفقهية.",
        keyFeatures: [
          "تركيز صارم على الأحاديث الأحكام الفقهية",
          "يتضمن تعليق الإمام أبي داود على علل الرواة",
          "يحتوي بقلة على المواضيع الأخلاقية والعقائدية للحفاظ على التركيز الفقهي",
          "أشاد به الإمام الغزالي باعتباره كافياً للمجتهد"
        ]
      },
      {
        id: "nasa-i",
        ...
        description: "تشتهر هذه المجموعة بجودتها الاستثنائية في تصنيف سلاسل الرواة والتقييم الدقيق للعلل الخفية في الحديث. وتصنف كواحدة من أقوى السنن.",
        keyFeatures: [
          "شروط صارمة للغاية للرواة، تقارب الصحيحين",
          "تركيز عميق على التفاصيل الفقهية الدقيقة والآثار القانونية (فقه النسائي)",
          "يحتوي على تحليل واسع للعلل الخفية في الأسانيد",
          "تصنيف شامل للأحاديث الضعيفة والصحيحة"
        ]
      },
      {
        id: "ibn-majah",
        ...
        description: "الكتاب السادس من الكتب الستة، يشتهر بتنظيمه الممتاز، وقلة تكرار الأحاديث، واشتماله على روايات نادرة تثري الفقه القانوني.",
        keyFeatures: [
          "ترتيب رائع في أبواب بتدفق منطقي ومنهجي للغاية",
          "الحد الأدنى من تكرار الأحاديث عبر الأبواب لإبقاء المجلد موجزًا",
          "يحتوي على أحاديث فريدة (زوائد) لا توجد في الكتب الخمسة الأخرى",
          "يتضمن قسماً تمهيدياً استثنائياً في حجية السنة النبوية"
        ]
      }
    ]
  }
