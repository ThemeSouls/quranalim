  ...
  "categories": [
    {
      ...
      "roles": [
        {
          "num": "1",
          "role": "👤 عام صارف / مہمان (Guest)",
          "desc": "بغیر کسی اکاؤنٹ کے قرآن مجید کی تلاوت، ترجمہ، تفسیر اور آڈیو سے استفادہ کریں۔ یہ آپ کا پہلا قدم ہے!"
        },
        {
          "num": "2",
          "role": "📝 رجسٹرڈ صارف (Registered User)",
          "desc": "مفت اکاؤنٹ بنا کر آیات کو بک مارک کریں، ذاتی نوٹس لکھیں، اپنی تلاوت کی پیش رفت کو ٹریک کریں، اور اپنی پسندیدہ ترتیبات محفوظ کریں۔"
        }
      ]
    },
    {
      ...
      "roles": [
        {
          "num": "3",
          "role": "✍️ مصنف (Author)",
          "desc": "کیا آپ نے کوئی اسلامی کتاب تصنیف کی ہے؟ اس کردار کے ذریعے اپنی کتابیں، رسائل، اور تحقیقی مقالات اپ لوڈ کریں اور پوری دنیا کے قارئین تک پہنچائیں۔"
        },
        {
          "num": "4",
          "role": "🎙️ قاری (Reciter)",
          "desc": "اپنی خوبصورت آواز میں قرآن مجید کی تلاوت ریکارڈ کرکے ہمارے پلیٹ فارم پر اپ لوڈ کریں۔ دنیا بھر کے مسلمان آپ کی آواز میں کلامِ پاک سنیں گے!"
        },
        {
          "num": "5",
          "role": "🌐 مترجم (Translator)",
          "desc": "قرآن مجید کا کسی بھی زبان میں ترجمہ کرنا چاہتے ہیں؟ یہ کردار آپ کو ایک آسان اور منظم ترجمہ انٹرفیس فراہم کرتا ہے۔ دنیا کی مختلف زبانوں میں قرآن کا پیغام پھیلائیں!"
        },
        {
          "num": "6",
          "role": "📚 عالم / مفسر (Scholar/Contributor)",
          "desc": "قرآن مجید کی تفسیر، تشریح، اور علمی حواشی لکھ کر جمع کروائیں۔ آپ کا علمی کام ہمارے ماہرین کی منظوری کے بعد شائع کیا جائے گا۔"
        },
        {
          "num": "7",
          "role": "🏫 معلم / کورس خالق (Instructor)",
          "desc": "آن لائن کورسز بنائیں! قرآن، حدیث، فقہ، عربی زبان، یا کوئی بھی اسلامی مضمون — ساختیہ کورسز کے ذریعے طلباء کو پڑھائیں اور ان کی پیش رفت مانیٹر کریں۔"
        },
        {
          "num": "8",
          "role": "🎤 مبلغ / خطیب (Preacher)",
          "desc": "آپ میدانِ وعظ و تبلیغ سے تعلق رکھتے ہیں؟ اپنے خطبات، بیانات، اور دروس کی آڈیو/ویڈیو اپ لوڈ کریں۔ لائیو نشر (Live Streaming) کی سہولت بھی دستیاب ہے۔"
        }
      ]
    },
    {
      ...
      "roles": [
        {
          "num": "9",
          "role": "🏛️ ادارہ (Organization)",
          "desc": "مساجد، مدارس، دارالعلوم، پبلشنگ ہاؤسز، اور فلاحی تنظیموں کے لیے مخصوص کردار۔ اپنے ادارے کو رجسٹر کریں، تصدیق (Verification) حاصل کریں، اور اپنے تحت متعدد اساتذہ و منتظمین کو جوڑ کر اپنا تمام علمی و دعوتی مواد ایک جگہ پیش کریں۔"
        },
        {
          "num": "10",
          "role": "✅ تصحیح کنندہ (Proofreader)",
          "desc": "علمی مواد کی درستگی کو یقینی بنانے والے ماہرین۔ آپ تراجم، تفاسیر، اور کتب کا جائزہ لے کر غلطیوں کی نشاندہی کرتے ہیں اور \"تصحیح شدہ\" کا اعزاز دیتے ہیں۔"
        },
        {
          "num": "11",
          "role": "🔬 محقق / تجزیہ کار (Researcher)",
          "desc": "گہرائی میں جا کر قرآن و علومِ اسلامیہ پر تحقیق کریں۔ تقابلی مطالعہ، موضوعاتی تلاش، اور حوالہ جات برآمد کرنے کی جدید سہولیات آپ کے لیے ہیں۔"
        },
        {
          "num": "12",
          "role": "🤝 معاون / رضاکار (Volunteer)",
          "desc": "پلیٹ فارم کو بہتر بنانے میں ہماری مدد کریں! غلطیوں کی نشاندہی، مواد کی درجہ بندی، اور کمیونٹی کی رہنمائی جیسے کاموں میں حصہ لیں۔"
        },
        {
          "num": "13",
          "role": "💰 خیرخواہ / مالی معاون (Donor)",
          "desc": "اس مفت علمی پلیٹ فارم کو چلانے میں مالی تعاون کریں۔ آپ کے تعاون سے ہم بغیر اشتہارات کے قرآن کا پیغام پوری دنیا میں پھیلا رہے ہیں۔ آپ کے پروفائل پر \"حامیِ قرآن\" کا اعزازی بیج لگایا جاتا ہے۔"
        },
        {
          "num": "14",
          "role": "🛡️ مدیر (Moderator)",
          "desc": "مواد کی منظوری، صارفین کی رہنمائی، اور پلیٹ فارم کے علمی معیار کو برقرار رکھنے کی ذمہ داری۔ ہمارے مدیران علمی امانت داری کے پاسبان ہیں۔"
        },
        {
          "num": "15",
          "role": "👑 منتظم اعلیٰ (Admin)",
          "desc": "پورے پلیٹ فارم کا انتظام و انصرام۔ صارفین کے کرداروں کا تعین، سسٹم کی ترتیبات، اور تمام تکنیکی و انتظامی امور کی نگرانی۔"
        }
      ]
    }
  ],
